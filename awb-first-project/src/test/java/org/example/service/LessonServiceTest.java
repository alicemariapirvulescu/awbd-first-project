...
public class LessonServiceTest {
    ...
    public void getLessons_UserNotFound_ThrowsException() {
        ...
        when(userService.getCurrentUser(anyString())).thenReturn(Optional.empty());

        assertThrows(DuolingoRuntimeException.class, () -> {
            lessonService.getLessons(languageName, "mockJwt");
        });
    }
    ...
    public void getLessons_UserNotEnrolledInAnyLanguages_ThrowsException() {
        ...
        when(userService.getCurrentUser(anyString())).thenReturn(Optional.of(mockUser));
    ...
    public void getLessons_Successful_ReturnsLessons() throws DuolingoRuntimeException {
        ...
        GetLessonsResponse response = lessonService.getLessons(languageName, "mockJwt");
