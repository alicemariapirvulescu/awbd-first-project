...
public class ResultService {
    ...
    public Page<Result> findResultsForLanguage(final String languageName, String jwt, Pageable pageable)
            throws DuolingoRuntimeException {
        ...
        return resultRepository.findAllByLanguageAndUser(language, currentUser, pageable);
